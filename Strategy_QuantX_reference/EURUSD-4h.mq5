...
//|    Generated at 06/11/2026 04:15
//| 
//|    Backtested on EURUSD_ftmo / H4, 2003.05.05 - 2026.06.09 
//+------------------------------------------------------------------+
...
input string CustomComment = "EURUSD_4h";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 2;        //MagicNumber
...
input int EMAPeriod1 = 200;        //EMAPeriod1
input int IndicatorCrsMAPrd1 = 99;        //IndicatorCrsMAPrd1
input int IndicatorCrsMAPrd2 = 5;        //IndicatorCrsMAPrd2
input int ATRFallingPeriod1 = 40;        //ATRFallingPeriod1
input int ExitAfterBars1 = 48;        //ExitAfterBars1
input double StopLossCoef1 = 4.3;        //StopLossCoef1
input int ExitAfterBars2 = 22;        //ExitAfterBars2
input double MoveSL2BECoef1 = 1.3;        //MoveSL2BECoef1
input double SL2BEAddPipsCoef1 = 1.8;        //SL2BEAddPipsCoef1
input double StopLossCoef2 = 1.9;        //StopLossCoef2
...
#define LOWESTINRANGE_1 1     //iCustom(NULL,0, "SqLowestInRange", "12:00", "2:00")
#define ATR_1 2     //iCustom(NULL,0, "SqATR", ATRFallingPeriod1)
#define ATR_2 3     //iCustom(NULL, 0, "SqATR", 20)
#define LOWESTINRANGE_2 4     //iCustom(NULL,0, "SqLowestInRange", "2:30", "11:00")
#define ATR_3 5     //iCustom(NULL, 0, "SqATR", 10)
#define ATR_4 6     //iCustom(NULL, 0, "SqATR", 90)
#define ATR_5 7     //iCustom(NULL, 0, "SqATR", 95)
#define HEIKENASHI_1 8     //iCustom(NULL,0, "SqHeikenAshi")
...
string sqStrategyName = "EURUSD-4h";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (((NormalizeDouble((double) sqClose(NULL,0, 1), 6) > NormalizeDouble((double) sqGetIndicatorValue(EMA_1, 0, 1), 6))
      &&   (NormalizeDouble((double) sqClose(NULL,0, 1), 6) > NormalizeDouble((double) sqOpen(NULL,0, 1), 6)))
      &&   (((sqIndicatorCrossesAboveMA("sqGetIndicatorValue(LOWESTINRANGE_1, 0, 2)",IndicatorCrsMAPrd1,1, 2))
      &&   sqBullishEngulfing(NULL,0, 3))
      &&   (sqIndicatorCrossesBelowMA("sqClose(NULL,0, 3)",IndicatorCrsMAPrd2,3, 2))));

     ShortEntrySignal = (((NormalizeDouble((double) sqClose(NULL,0, 1), 6) < NormalizeDouble((double) sqGetIndicatorValue(EMA_1, 0, 1), 6))
      &&   (NormalizeDouble((double) sqClose(NULL,0, 1), 6) < NormalizeDouble((double) sqOpen(NULL,0, 1), 6)))
      &&   sqIsFalling(ATR_1, 2, false, 3));

     LongExitSignal = false;

     ShortExitSignal = (NormalizeDouble((double) sqHeikenAshi("NULL",0, "Open", 1), 6) <= NormalizeDouble((double) sqOpen(NULL,0, 2), 6));
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice(sqGetIndicatorValue(LOWESTINRANGE_2, 0, 2), "Current");
      ...
      pt = sqFixMarketPrice(0, "Current");
      size = sqMMFixedAmount("Current",ORDER_TYPE_SELL_STOP,openPrice,sl,mmRiskedMoney,mmDecimals,mmLotsIfNoMM,mmMaxLots,mmMultiplier,mmStep);
      ...
      if(_ticket > 0) {
         ...
         sqSetMoveSL2BE(_ticket, "MoveSL2BECoef1 * sqGetIndicatorValue(ATR_3, 1)", SLPTTYPE_RANGE);
         sqSetSL2BEAddPips(_ticket, "SL2BEAddPipsCoef1 * sqGetIndicatorValue(ATR_4, 1)");

         // TrailingStop initialization
         sqSetTrailingStop(_ticket, "TrailingStopCoef1 * sqGetIndicatorValue(ATR_5, 1)", SLPTTYPE_RANGE);

         // ExitAfterBars initialization
         sqSetExitAfterXBars(_ticket, ExitAfterBars2);
      }
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[LOWESTINRANGE_1] = iCustom(NULL,0, "SqLowestInRange", "12:00", "2:00");
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_1] = iCustom(NULL,0, "SqATR", ATRFallingPeriod1);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_2] = iCustom(NULL, 0, "SqATR", 20);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[LOWESTINRANGE_2] = iCustom(NULL,0, "SqLowestInRange", "2:30", "11:00");
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_3] = iCustom(NULL, 0, "SqATR", 10);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_4] = iCustom(NULL, 0, "SqATR", 90);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_5] = iCustom(NULL, 0, "SqATR", 95);
...
double sqGetValueByIdentification(int idHash) {
   ...
   if(idHash == sqStringHash("MoveSL2BECoef1 * sqGetIndicatorValue(ATR_3, 1)")) {
      return (MoveSL2BECoef1 * sqGetIndicatorValue(ATR_3, 1));
   }
   if(idHash == sqStringHash("SL2BEAddPipsCoef1 * sqGetIndicatorValue(ATR_4, 1)")) {
      return (SL2BEAddPipsCoef1 * sqGetIndicatorValue(ATR_4, 1));
   }
...
double sqGetExpressionByIdentification(string id, int shift) {
      if(id == "sqGetIndicatorValue(LOWESTINRANGE_1, 0, 2)") {
          return sqGetIndicatorValue(LOWESTINRANGE_1, 0, shift + 2);
      }
...
//+----------------------------- Include from /MetaTrader5/CustomFunctions/sqIsGreaterPercentile.mq5 -------------------------------------+
...
//+----------------------------- Include from /MetaTrader5/CustomFunctions/sqIsLowerPercentile.mq5 -------------------------------------+
