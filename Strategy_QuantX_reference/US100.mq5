...
//| 
//|    Backtested on US100_ftmo / H1, 2009.01.02 - 2026.05.29 
//+------------------------------------------------------------------+
...
input string CustomComment = "US100";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 7;        //MagicNumber
...
input double StopLossCoef1 = 4.7;        //StopLossCoef1
...
#define HIGHEST_1 0     //iCustom(NULL,0, "SqHighest", Period1, PRICE_TYPICAL)
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = ((getSQTime(sqTime(NULL,0, 0)) == sqGetTime(2, 0 , 0))
      &&   (sqIsLowerPercentile("sqGetIndicatorValue(HIGHEST_1, 0, 2)",85.1,123,3)));
...
double sqGetExpressionByIdentification(string id, int shift) {
      if(id == "sqGetIndicatorValue(HIGHEST_1, 0, 2)") {
          return sqGetIndicatorValue(HIGHEST_1, 0, shift + 2);
      }
