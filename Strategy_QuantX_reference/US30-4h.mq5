...
//| 
//|    Backtested on US30_ftmo / H4, 2009.01.02 - 2026.05.29 
//+------------------------------------------------------------------+
...
input string CustomComment = "US30_4h";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 8;        //MagicNumber
...
input double MoveSL2BECoef1 = 2.8;        //MoveSL2BECoef1
input double ProfitTargetCoef1 = 5.9;        //ProfitTargetCoef1
input double StopLossCoef1 = 1.5;        //StopLossCoef1
input double TrailingStopCoef1 = 1.2;        //TrailingStopCoef1
...
#define LOWESTINRANGE_1 0     //iCustom(NULL,0, "SqLowestInRange", "0:30", "17:00")
#define MOVINGAVERAGE_1 1     //iMA(NULL,0, MABarClosesPeriod1, 0, MODE_LWMA, PRICE_CLOSE)
#define HIGHEST_1 2     //iCustom(NULL,0, "SqHighest", Period1, PRICE_LOW)
#define LOWESTINRANGE_2 3     //iCustom(NULL,0, "SqLowestInRange", "7:00", "18:30")
#define ATR_1 4     //iCustom(NULL, 0, "SqATR", 85)
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = ((sqIsLowerPercentile("sqGetIndicatorValue(LOWESTINRANGE_1, 0, 3)",28.7,687,1))
      &&   (sqClose("NULL",0, 1) > sqGetIndicatorValue(MOVINGAVERAGE_1, 1)));

     ShortEntrySignal = false;

     LongExitSignal = (NormalizeDouble((double) sqGetIndicatorValue(HIGHEST_1, 0, 1), 6) >= NormalizeDouble((double) sqGetIndicatorValue(LOWESTINRANGE_2, 0, 3), 6));
...
//------------------------
...
)
   {
      ...
      pt = sqFixMarketPrice(sqGetPTLevel("Current", ORDER_TYPE_BUY, openPrice, 2, ProfitTargetCoef1 * sqGetIndicatorValue(ATR_2, 1)), "Current");
...
bool initIndicators(){
   ...
   indicatorHandles[LOWESTINRANGE_1] = iCustom(NULL,0, "SqLowestInRange", "0:30", "17:00");
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[MOVINGAVERAGE_1] = iMA(NULL,0, MABarClosesPeriod1, 0, MODE_LWMA, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[HIGHEST_1] = iCustom(NULL,0, "SqHighest", Period1, PRICE_LOW);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[LOWESTINRANGE_2] = iCustom(NULL,0, "SqLowestInRange", "7:00", "18:30");
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_1] = iCustom(NULL, 0, "SqATR", 85);
...
double sqGetExpressionByIdentification(string id, int shift) {
      if(id == "sqGetIndicatorValue(LOWESTINRANGE_1, 0, 3)") {
          return sqGetIndicatorValue(LOWESTINRANGE_1, 0, shift + 3);
      }
