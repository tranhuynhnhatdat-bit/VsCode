...
//| 
//|    Backtested on USDJPY_ftmo / H1, 2003.05.05 - 2026.06.03 
//+------------------------------------------------------------------+
...
input string CustomComment = "USDJPY";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 12;        //MagicNumber
...
input int MABarClosesPeriod1 = 40;        //MABarClosesPeriod1
input double StopLossCoef1 = 4.2;        //StopLossCoef1
input double StopLossCoef2 = 2.6;        //StopLossCoef2
...
#define KELTNERCHANNEL_1 0     //iCustom(NULL,0, "SqKeltnerChannel", KCBarOpenserPeriod1, 0.3)
#define MOVINGAVERAGE_1 1     //iMA(NULL,0, MABarClosesPeriod1, 0, MODE_EMA, PRICE_TYPICAL)
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (((sqTimeHour(sqTime(NULL,0, 0)) == 9)
      &&   (sqTimeDayOfWeek(sqTime(NULL,0, 0)) == 3))
      &&   (sqIsGreaterCount("sqGetAsk(\"Current\")","sqLow(NULL,0, 2)",6,false,1)));

     ShortEntrySignal = (((sqTimeHour(sqTime(NULL,0, 0)) == 2)
     ...
     LongExitSignal = (sqTimeHour(sqTime(NULL,0, 0)) == 23);

     ShortExitSignal = (sqTimeHour(sqTime(NULL,0, 0)) == 7);
...
bool initIndicators(){
   ...
   indicatorHandles[KELTNERCHANNEL_1] = iCustom(NULL,0, "SqKeltnerChannel", KCBarOpenserPeriod1, 0.3);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[MOVINGAVERAGE_1] = iMA(NULL,0, MABarClosesPeriod1, 0, MODE_EMA, PRICE_TYPICAL);
...
double sqGetExpressionByIdentification(string id, int shift) {
      if(id == "sqGetAsk(\"Current\")") {
          return   sqGetAsk("Current");
      }
