...
//| 
//|    Backtested on AUDUSD_ftmo / H1, 2003.08.04 - 2026.06.09 
//+------------------------------------------------------------------+
...
input string CustomComment = "AUDUSD";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 1;        //MagicNumber
...
input double StopLossCoef2 = 4.8;        //StopLossCoef2
...
#define KELTNERCHANNEL_1 0     //iCustom(NULL,0, "SqKeltnerChannel", KCerPeriod1, 2.25)
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (((sqTimeHour(sqTime(NULL,0, 0)) == 3)
      &&   (sqTimeDayOfWeek(sqTime(NULL,0, 0)) == 4))
      &&   ((NormalizeDouble((double) sqHeikenAshi("NULL",0, "Close", 1), 6) <= NormalizeDouble((double) sqHeikenAshi("NULL",0, "Open", 2), 6))
      &&   (NormalizeDouble((double) sqGetBid("Current"), 6) <= NormalizeDouble((double) sqHeikenAshi("NULL",0, "Open", 2), 6))));

     ShortEntrySignal = (((sqTimeHour(sqTime(NULL,0, 0)) == 22)
      &&   (sqTimeDayOfWeek(sqTime(NULL,0, 0)) == 4))
      &&   ((sqIsRising(KELTNERCHANNEL_1, 2, false, 3, 1)
      &&   (NormalizeDouble((double) sqHeikenAshi("NULL",0, "Open", 2), 6) <= NormalizeDouble((double) sqHeikenAshi("NULL",0, "Open", 1), 6)))
      &&   (NormalizeDouble((double) sqHeikenAshi("NULL",0, "Close", 3), 6) <= NormalizeDouble((double) sqGetBid("Current"), 6))));

     LongExitSignal = (sqTimeHour(sqTime(NULL,0, 0)) == 12);

     ShortExitSignal = (sqTimeHour(sqTime(NULL,0, 0)) == 14);
...
bool initIndicators(){
   ...
   indicatorHandles[KELTNERCHANNEL_1] = iCustom(NULL,0, "SqKeltnerChannel", KCerPeriod1, 2.25);
