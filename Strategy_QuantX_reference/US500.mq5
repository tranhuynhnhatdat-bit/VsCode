...
//| 
//|    Backtested on US500_ftmo / H1, 2009.01.02 - 2026.05.29 
//+------------------------------------------------------------------+
...
input string CustomComment = "US500";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 10;        //MagicNumber
...
input int ExitAfterBars1 = 20;        //ExitAfterBars1
...
#define LOWESTINRANGE_1 0     //iCustom(NULL,0, "SqLowestInRange", "12:30", "10:30")
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = ((((sqTimeHour(sqTime(NULL,0, 0)) == 2)
      ...
      &&   (sqIsLowerPercentile("sqGetIndicatorValue(LOWESTINRANGE_1, 0, 1)",46.6,386,1)));
...
bool initIndicators(){
   ...
   indicatorHandles[LOWESTINRANGE_1] = iCustom(NULL,0, "SqLowestInRange", "12:30", "10:30");
...
double sqGetExpressionByIdentification(string id, int shift) {
      if(id == "sqGetIndicatorValue(LOWESTINRANGE_1, 0, 1)") {
          return sqGetIndicatorValue(LOWESTINRANGE_1, 0, shift + 1);
      }
