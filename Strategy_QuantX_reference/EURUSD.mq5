...
//| 
//|    Backtested on EURUSD_ftmo / H1, 2003.05.05 - 2026.05.21 
//+------------------------------------------------------------------+
...
input string CustomComment = "EURUSD";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 3;        //MagicNumber
...
input int IndicatorCrsMAPrd1 = 30;        //IndicatorCrsMAPrd1
input int KCerPeriod1 = 20;        //KCerPeriod1
input double StopLossCoef1 = 2.4;        //StopLossCoef1
input double StopLossCoef2 = 4.6;        //StopLossCoef2
...
#define KELTNERCHANNEL_1 0     //iCustom(NULL,0, "SqKeltnerChannel", KCerPeriod1, 1.3)
#define ATR_1 1     //iCustom(NULL, 0, "SqATR", 20)
#define HEIKENASHI_1 2     //iCustom(NULL,0, "SqHeikenAshi")
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (((getSQTime(sqTime(NULL,0, 0)) == sqGetTime(1, 0 , 0))
      &&   (sqTimeDayOfWeek(sqTime(NULL,0, 0)) == 4))
      &&   (sqIndicatorCrossesBelowMA("MathMax(sqHigh(\"NULL\",0, 2), MathMax(sqHeikenAshi(\"NULL\",0,\"Open\", 2), sqHeikenAshi(\"NULL\",0,\"Close\", 2)))",IndicatorCrsMAPrd1,4, 1)));

     ShortEntrySignal = (((sqTimeHour(sqTime(NULL,0, 0)) == 9)
      &&   (sqTimeDayOfWeek(sqTime(NULL,0, 0)) == 5))
      &&   sqIsFalling(KELTNERCHANNEL_1, 2, false, 1, 1));

     LongExitSignal = (getSQTime(sqTime(NULL,0, 0)) == sqGetTime(12, 0 , 0));

     ShortExitSignal = (sqTimeHour(sqTime(NULL,0, 0)) == 15);
...
bool initIndicators(){
   ...
   indicatorHandles[KELTNERCHANNEL_1] = iCustom(NULL,0, "SqKeltnerChannel", KCerPeriod1, 1.3);
...
double sqGetExpressionByIdentification(string id, int shift) {
      if(id == "MathMax(sqHigh(\"NULL\",0, 2), MathMax(sqHeikenAshi(\"NULL\",0,\"Open\", 2), sqHeikenAshi(\"NULL\",0,\"Close\", 2)))") {
          return   MathMax(sqHigh("NULL",0, shift + 2), MathMax(sqHeikenAshi("NULL",0, "Open", shift + 2), sqHeikenAshi("NULL",0, "Close", shift + 2)));
      }
