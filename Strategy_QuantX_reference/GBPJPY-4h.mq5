...
//| 
//|    Backtested on GBPJPY_ftmo / H4, 2003.08.04 - 2026.06.09 
//+------------------------------------------------------------------+
...
input string CustomComment = "GBPJPY_4h";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 4;        //MagicNumber
...
input int IndicatorCrsMAPrd1 = 20;        //IndicatorCrsMAPrd1
input int BBBarClosesPeriod1 = 50;        //BBBarClosesPeriod1
input double MoveSL2BECoef1 = 1.6;        //MoveSL2BECoef1
input double StopLossCoef1 = 3.5;        //StopLossCoef1
input double PriceEntryMult1 = 1.3;        //PriceEntryMult1
input double MoveSL2BECoef2 = 1.8;        //MoveSL2BECoef2
input double StopLossCoef2 = 3.6;        //StopLossCoef2
...
#define LOWESTINRANGE_1 1     //iCustom(NULL,0, "SqLowestInRange", "7:30", "11:30")
#define LOWEST_2 2     //iCustom(NULL,0, "SqLowest", Period1, PRICE_CLOSE)
#define KELTNERCHANNEL_1 3     //iCustom(NULL,0, "SqKeltnerChannel", KCBarOpenserPeriod1, 2.5)
#define BOLLINGERBANDS_1 4     //iBands(NULL,0, BBBarClosesPeriod1, 0, 1.9, PRICE_CLOSE)
#define ATR_1 5     //iCustom(NULL, 0, "SqATR", 75)
#define ATR_2 6     //iCustom(NULL, 0, "SqATR", 20)
#define BOLLINGERBANDS_2 7     //iBands(NULL,0, 8, 0, 2.0, PRICE_WEIGHTED)
#define BBWIDTHRATIO_1 8     //iCustom(NULL,0, "SqBBWidthRatio", 19, 0.7, PRICE_LOW)
#define ATR_3 9     //iCustom(NULL, 0, "SqATR", 175)
#define ATR_4 10     //iCustom(NULL, 0, "SqATR", 145)
#define HEIKENASHI_1 11     //255
...
string sqStrategyName = "GBPJPY-4h";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = ((NormalizeDouble((double) sqClose(NULL,0, 0), 6) > NormalizeDouble((double) sqGetIndicatorValue(HIGHEST_1, 0, 1), 6))
      &&   (NormalizeDouble((double) sqClose(NULL,0, 1), 6) != NormalizeDouble((double) sqGetIndicatorValue(LOWESTINRANGE_1, 0, 1), 6)));

     ShortEntrySignal = ((NormalizeDouble((double) sqClose(NULL,0, 0), 6) < NormalizeDouble((double) sqGetIndicatorValue(LOWEST_2, 0, 1), 6))
      &&   ((sqOpen("NULL",0, 2) < sqGetIndicatorValue(KELTNERCHANNEL_1, 0, 2+1))
      &&   (sqIsGreaterPercentile("sqClose(NULL,0, 3)",98.2,985,1))));

     LongExitSignal = (((sqIndicatorCrossesBelowMA("sqClose(NULL,0, 3)",IndicatorCrsMAPrd1,3, 2))
      &&   (sqClose("NULL",0, 3) < sqGetIndicatorValue(BOLLINGERBANDS_1, 1, 3)))
      &&   (sqIsGreaterPercentile("sqLow(NULL,0, 1)",11.3,629,2)));
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(BOLLINGERBANDS_2, 1 + 1, 1) - (PriceEntryMult1 * sqGetIndicatorValue(BBWIDTHRATIO_1, 0, 1))), "Current");
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 68);

         //Check StopLoss & ProfitTarget
         //sqCheckSLPT(_ticket, sl, pt);
         // MoveSL2BE initialization
         sqSetMoveSL2BE(_ticket, "MoveSL2BECoef2 * sqGetIndicatorValue(ATR_3, 1)", SLPTTYPE_RANGE);
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[LOWESTINRANGE_1] = iCustom(NULL,0, "SqLowestInRange", "7:30", "11:30");
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[LOWEST_2] = iCustom(NULL,0, "SqLowest", Period1, PRICE_CLOSE);
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_2] = iBands(NULL,0, 8, 0, 2.0, PRICE_WEIGHTED);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BBWIDTHRATIO_1] = iCustom(NULL,0, "SqBBWidthRatio", 19, 0.7, PRICE_LOW);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_3] = iCustom(NULL, 0, "SqATR", 175);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_4] = iCustom(NULL, 0, "SqATR", 145);
...
double sqGetValueByIdentification(int idHash) {
   ...
   if(idHash == sqStringHash("MoveSL2BECoef2 * sqGetIndicatorValue(ATR_3, 1)")) {
      return (MoveSL2BECoef2 * sqGetIndicatorValue(ATR_3, 1));
   }
