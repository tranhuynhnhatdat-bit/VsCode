...
//| 
//|    Backtested on USOIL_ftmo / H1, 2009.01.01 - 2026.06.05 
//+------------------------------------------------------------------+
...
input string CustomComment = "USOIL";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 14;        //MagicNumber
...
input double StopLossCoef2 = 3.5;        //StopLossCoef2
...
#define HIGHESTINRANGE_1 0     //iCustom(NULL,0, "SqHighestInRange", "3:30", "0:00")
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (((sqTimeHour(sqTime(NULL,0, 0)) == 23)
      &&   (sqTimeDayOfWeek(sqTime(NULL,0, 0)) == 4))
      &&   (NormalizeDouble((double) sqGetIndicatorValue(HIGHESTINRANGE_1, 0, 2), 6) >= NormalizeDouble((double) MathMin(sqLow("NULL",0, 1), MathMin(sqHeikenAshi("NULL",0, "Open", 1), sqHeikenAshi("NULL",0, "Close", 1))), 6)));

     ShortEntrySignal = (((sqTimeHour(sqTime(NULL,0, 0)) == 3)
      &&   (sqTimeDayOfWeek(sqTime(NULL,0, 0)) == 1))
      &&   (NormalizeDouble((double) MathMax(sqHigh("NULL",0, 3), MathMax(sqHeikenAshi("NULL",0, "Open", 3), sqHeikenAshi("NULL",0, "Close", 3))), 6) <= NormalizeDouble((double) sqGetAsk("Current"), 6)));

     LongExitSignal = (sqTimeHour(sqTime(NULL,0, 0)) == 6);

     ShortExitSignal = (sqTimeHour(sqTime(NULL,0, 0)) == 16);
...
bool initIndicators(){
   ...
   indicatorHandles[HIGHESTINRANGE_1] = iCustom(NULL,0, "SqHighestInRange", "3:30", "0:00");
