...
//| NZDUSD EA
//|
//|    Generated by StrategyQuant X Build 143 for AlgoCloud
//|    Generated at 06/11/2026 04:15
//| 
//|    Backtested on NZDUSD_ftmo / H1, 2003.08.04 - 2026.06.05 
//+------------------------------------------------------------------+
...
input string CustomComment = "NZDUSD";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 6;        //MagicNumber
...
input int IndicatorMAPeriod1 = 144;        //IndicatorMAPeriod1
input int IndicatorMAPeriod2 = 59;        //IndicatorMAPeriod2
input int MABarOpensPeriod1 = 50;        //MABarOpensPeriod1
input int IndicatorMAPeriod3 = 146;        //IndicatorMAPeriod3
input double StopLossCoef1 = 4.6;        //StopLossCoef1
...
#define HIGHESTINRANGE_1 0     //iCustom(NULL,0, "SqHighestInRange", "23:30", "22:30")
#define MOVINGAVERAGE_1 1     //iMA(NULL,0, MABarOpensPeriod1, 0, MODE_EMA, PRICE_CLOSE)
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (((sqTimeHour(sqTime(NULL,0, 0)) == 1)
      &&   (sqTimeDayOfWeek(sqTime(NULL,0, 0)) == 1))
      &&   (sqIsIndicatorBelowMA("sqGetIndicatorValue(HIGHESTINRANGE_1, 0, 3)",IndicatorMAPeriod1,1, 2)));

     ShortEntrySignal = (((sqTimeHour(sqTime(NULL,0, 0)) == 12)
      &&   (sqTimeDayOfWeek(sqTime(NULL,0, 0)) == 4))
      &&   (((sqIsIndicatorBelowMA("sqHeikenAshi(\"NULL\",0,\"Close\", 3)",IndicatorMAPeriod2,4, 2))
      &&   (sqOpen("NULL",0, 2) < sqGetIndicatorValue(MOVINGAVERAGE_1, 2+1)))
      &&   (sqIsIndicatorAboveMA("sqHeikenAshi(\"NULL\",0,\"Close\", 1)",IndicatorMAPeriod3,4, 2))));

     LongExitSignal = (sqTimeHour(sqTime(NULL,0, 0)) == 19);

     ShortExitSignal = (sqTimeHour(sqTime(NULL,0, 0)) == 4);
...
//------------------------
...
)
   {
      ...
      sl = sqFixMarketPrice(sqGetSLLevel("Current", ORDER_TYPE_SELL, openPrice, 2, StopLossCoef2 * sqGetIndicatorValue(ATR_1, 1)), "Current");
      pt = sqFixMarketPrice(0, "Current");
      size = sqMMFixedAmount("Current",ORDER_TYPE_SELL,openPrice,sl,mmRiskedMoney,mmDecimals,mmLotsIfNoMM,mmMaxLots,mmMultiplier,mmStep);
...
bool initIndicators(){
   ...
   indicatorHandles[HIGHESTINRANGE_1] = iCustom(NULL,0, "SqHighestInRange", "23:30", "22:30");
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[MOVINGAVERAGE_1] = iMA(NULL,0, MABarOpensPeriod1, 0, MODE_EMA, PRICE_CLOSE);
...
double sqGetExpressionByIdentification(string id, int shift) {
      if(id == "sqGetIndicatorValue(HIGHESTINRANGE_1, 0, 3)") {
          return sqGetIndicatorValue(HIGHESTINRANGE_1, 0, shift + 3);
      }
      if(id == "sqHeikenAshi(\"NULL\",0,\"Close\", 3)") {
          return   sqHeikenAshi("NULL",0, "Close", shift + 3);
      }
      if(id == "sqHeikenAshi(\"NULL\",0,\"Close\", 1)") {
          return   sqHeikenAshi("NULL",0, "Close", shift + 1);
      }
