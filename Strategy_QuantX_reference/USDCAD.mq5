...
//| 
//|    Backtested on USDCAD_ftmo / H1, 2004.10.25 - 2026.06.09 
//+------------------------------------------------------------------+
...
input string CustomComment = "USDCAD";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 11;        //MagicNumber
...
input int IndicatorMAPeriod1 = 185;        //IndicatorMAPeriod1
input double StopLossCoef1 = 4.5;        //StopLossCoef1
input double StopLossCoef2 = 3.3;        //StopLossCoef2
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (((sqTimeHour(sqTime(NULL,0, 0)) == 2)
      &&   (sqTimeDayOfWeek(sqTime(NULL,0, 0)) == 5))
      &&   ((sqIsFalling("sqClose(NULL,0, 2)", 2, true, 0 + 1, 0))
      &&   (sqIsGreaterPercentile("MathMin(sqLow(\"NULL\",0, 3), MathMin(sqHeikenAshi(\"NULL\",0,\"Open\", 3), sqHeikenAshi(\"NULL\",0,\"Close\", 3)))",12.4,189,1))));

     ShortEntrySignal = (((sqTimeHour(sqTime(NULL,0, 0)) == 18)
      &&   (sqTimeDayOfWeek(sqTime(NULL,0, 0)) == 3))
      &&   (sqIsIndicatorAboveMA("sqClose(NULL,0, 2)",IndicatorMAPeriod1,2, 2)));

     LongExitSignal = (sqTimeHour(sqTime(NULL,0, 0)) == 15);

     ShortExitSignal = (sqTimeHour(sqTime(NULL,0, 0)) == 21);
...
double sqGetExpressionByIdentification(string id, int shift) {
      if(id == "sqClose(NULL,0, 2)") {
          return   sqClose(NULL,0, shift + 2);
      }
      if(id == "MathMin(sqLow(\"NULL\",0, 3), MathMin(sqHeikenAshi(\"NULL\",0,\"Open\", 3), sqHeikenAshi(\"NULL\",0,\"Close\", 3)))") {
          return   MathMin(sqLow("NULL",0, shift + 3), MathMin(sqHeikenAshi("NULL",0, "Open", shift + 3), sqHeikenAshi("NULL",0, "Close", shift + 3)));
      }
