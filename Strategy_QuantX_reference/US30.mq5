...
//| 
//|    Backtested on US30_ftmo / H1, 2009.01.02 - 2026.05.29 
//+------------------------------------------------------------------+
...
input string CustomComment = "US30";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 9;        //MagicNumber
...
int Start = 2;        //Start
int End = 23;        //End
input int BBBarClosesPeriod1 = 109;        //BBBarClosesPeriod1
input int ExitAfterBars1 = 12;        //ExitAfterBars1
...
#define BOLLINGERBANDS_1 0     //iBands(NULL,0, BBBarClosesPeriod1, 0, 1.6, PRICE_WEIGHTED)
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = ((getSQTime(sqTime(NULL,0, 0)) == sqGetTime(2, 0 , 0))
      &&   (sqClose("NULL",0, 1) > sqGetIndicatorValue(BOLLINGERBANDS_1, 1, 1)));

     ShortEntrySignal = false;

     LongExitSignal = (getSQTime(sqTime(NULL,0, 0)) == sqGetTime(23, 0 , 0));
...
bool initIndicators(){
   ...
   indicatorHandles[BOLLINGERBANDS_1] = iBands(NULL,0, BBBarClosesPeriod1, 0, 1.6, PRICE_WEIGHTED);
