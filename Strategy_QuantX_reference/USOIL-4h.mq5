...
//| 
//|    Backtested on USOIL_ftmo / H4, 2009.01.01 - 2026.06.05 
//+------------------------------------------------------------------+
...
input string CustomComment = "USOIL_4h";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 13;        //MagicNumber
...
input int ADXLowerPeriod1 = 20;        //ADXLowerPeriod1
input int KCBarCloseserPeriod1 = 20;        //KCBarCloseserPeriod1
input int ExitAfterBars1 = 4;        //ExitAfterBars1
input double MoveSL2BECoef1 = 2.1;        //MoveSL2BECoef1
input double StopLossCoef1 = 1.6;        //StopLossCoef1
input double PriceEntryMult1 = 2.7;        //PriceEntryMult1
input double ProfitTargetCoef1 = 6.3;        //ProfitTargetCoef1
input double StopLossCoef2 = 1.9;        //StopLossCoef2
input double TrailingStopCoef1 = 2.4;        //TrailingStopCoef1
input double TrailingActCef1 = 4.2;        //TrailingActCef1
...
#define HIGHESTINRANGE_1 0     //iCustom(NULL,0, "SqHighestInRange", "11:30", "13:30")
#define ADX_1 1     //iCustom(NULL,0, "SqADX", ADXLowerPeriod1)
#define KELTNERCHANNEL_1 2     //iCustom(NULL,0, "SqKeltnerChannel", KCBarCloseserPeriod1, 2.25)
#define LWMA_1 3     //iMA(NULL,0, 93, 0, MODE_LWMA, PRICE_HIGH)
#define ATR_1 4     //iCustom(NULL, 0, "SqATR", 40)
#define ATR_2 5     //iCustom(NULL, 0, "SqATR", 20)
#define MTATR_1 6     //iATR(NULL,0, 171)
#define ATR_3 7     //iCustom(NULL, 0, "SqATR", 5)
#define ATR_4 8     //iCustom(NULL, 0, "SqATR", 170)
...
string sqStrategyName = "USOIL-4h";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (NormalizeDouble((double) sqGetIndicatorValue(HIGHESTINRANGE_1, 0, 2), 6) != NormalizeDouble((double) sqGetAsk("Current"), 6));

     ShortEntrySignal = sqGetIndicatorValue(ADX_1, 3) < 31.48;

     LongExitSignal = (sqClose("NULL",0, 2) > sqGetIndicatorValue(KELTNERCHANNEL_1, 0, 2));
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice(sqGetIndicatorValue(LWMA_1, 0, 1), "Current");
      ...
      size = sqMMFixedAmount("Current",ORDER_TYPE_BUY_STOP,openPrice,sl,mmRiskedMoney,mmDecimals,mmLotsIfNoMM,mmMaxLots,mmMultiplier,mmStep);
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 51);
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetBid("Current") + (PriceEntryMult1 * sqGetIndicatorValue(MTATR_1, 0, 2))), "Current");
      ...
      pt = sqFixMarketPrice(sqGetPTLevel("Current", ORDER_TYPE_SELL_STOP, openPrice, 2, ProfitTargetCoef1 * sqGetIndicatorValue(ATR_2, 1)), "Current");
      ...
      if(_ticket > 0) {
         // order was successfuly placed, set or initialize all its exit methods (SL, PT, Trailing Stop, Exit After Bars, etc.)
         sqSetOrderExpiration(_ticket, 173);
...
bool initIndicators(){
   ...
   indicatorHandles[HIGHESTINRANGE_1] = iCustom(NULL,0, "SqHighestInRange", "11:30", "13:30");
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ADX_1] = iCustom(NULL,0, "SqADX", ADXLowerPeriod1);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[KELTNERCHANNEL_1] = iCustom(NULL,0, "SqKeltnerChannel", KCBarCloseserPeriod1, 2.25);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[LWMA_1] = iMA(NULL,0, 93, 0, MODE_LWMA, PRICE_HIGH);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_1] = iCustom(NULL, 0, "SqATR", 40);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_2] = iCustom(NULL, 0, "SqATR", 20);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[MTATR_1] = iATR(NULL,0, 171);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_3] = iCustom(NULL, 0, "SqATR", 5);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_4] = iCustom(NULL, 0, "SqATR", 170);
...
double sqGetValueByIdentification(int idHash) {
   ...
   if(idHash == sqStringHash("ProfitTargetCoef1 * sqGetIndicatorValue(ATR_2, 1)")) {
      return (ProfitTargetCoef1 * sqGetIndicatorValue(ATR_2, 1));
   }
