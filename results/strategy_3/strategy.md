...
**Stop loss:** `2.0 × ATR(14)`. No take-profit; the session close is the profit exit.
...
| `cond1_period` | `11` |
| `cond1_ind` | `SMA` |
| `cond1_threshold` | `45.0` |
| `cond2_type` | `price_ind` |
| `cond2_op` | `lt` |
| `cond2_period` | `6` |
| `cond2_ind` | `EMA` |
| `cond2_threshold` | `70.0` |
...
ON each closed H1 bar:
  ...
  RISK : on BUY, SL = entry_ask − 2.0 × ATR(14)
```
...
|-------|:-------------:|:------:|:------------:|:----------:|
| H1 train (Stage 1) | 1.29 | 534 | 3.83 | 57.87 |
| M1 train (Stage 2) | 1.29 | 534 | 3.83 | 57.87 |
| M1 OOS1 (Stage 3) | 1.52 | 319 | 3.81 | 55.80 |
| M1 OOS2 (Stage 3) | 1.13 | 194 | 3.48 | 52.58 |
